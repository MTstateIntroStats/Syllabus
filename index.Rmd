...
grades$category <- fct_relevel(grades$category, "Video/Reading Quizzes", "Engagement", "Module Labs" , "Assignments", "Midterm exams (2)", "Final exam")
...
* Each student will also turn in each lab for completion at the **beginning of the following class period** for that class period's Engagement grade.
