...
* [STAT 216 calendar](calendars/F23-Stat216_Calendar.pdf)
...
* **read** assigned sections of the online textbook on that week's content ***prior*** to attending your assigned in-person class day, including concept check video quizzes located in Gradescope,
* students will work in assigned groups three class periods per week for **in-class group activities and discussion** (Mondays and Wednesdays) and **in-class Rstudio labs** (Friday), with these groups changing each unit. 
...
grades$category <- fct_relevel(grades$category, "Videos", "Activities", "Labs" , "Assignments", "Midterm exams (2)", "Final exam")
...
You will be expected to complete the assigned textbook reading and we recommend using the reading guides provided in the coursepack prior to each Monday class.  Additionally, you need to view the required videos (as shown on the [STAT 216 calendar](calendars/S23-Stat216_Calendar.pdf)) and complete the video concept check quizzes found on Gradescope by **11:59pm every Sunday**. Up until the 11:59pm Sunday deadline, you can retake the video quizzes as many times as you like by clicking Resubmit in Gradescope to open and edit any question answer. After the due date, videos will still be available to review, but the Gradescope video quiz will be closed. 

* Video quizzes are due **Sunday at 11:59pm Mountain Time each week**.
* The lowest video grade will be dropped.
...
* Policy for missed activities: 
    ...
    + Students get a “free pass” for up to three activities per Unit, no questions asked. Illnesses/emergencies/school-related absences are included in these three; if students have extraneous circumstances, they are encouraged to talk to their instructor. 
...
* Each group will turn in selected questions from the lab to Gradescope. Labs are due **Friday at 8pm Mountain Time each week**.
...
Individual midterm exam 1 will be **February 17th**; Individual midterm exam 2 will be **March 31st**. 
...
Group final exam will be **May 3rd and 5th (during normal class time)**. 
...
Individual common hour final exam will be **Tuesday, May 9th from 12:00 - 1:50pm**. 
...
* **Videos**: You may take the video quizzes in Gradescope as many times as you like up until the due date using the Resubmit button to re-open a quiz. Videos are available in D2L at least one week prior to the due date, so extensions on these quizzes are not given unless extenuating circumstances that prevent the student from viewing the video for that entire period.
...
* **Exams**: 
    - Students that are in quarantine but healthy enough to take the exam should email Student Success Coordinator [Jade Schmidt](mailto: jade.schmidt2@montana.edu) to make alternative arrangements.  Group exams may be taken remotely and proctored via WebEx but all individual exams must be taken in person.
