...
The list of instructors for each section/time/location is listed below.  Click on the tab to find the contact information for your section instructor.  Note that all sections meet in Romney 211, unless noted otherwise below.

Section 001 (8 - 8:50 am): Jade Schmidt

Section 002 (9 - 9:50 am): Jade Schmidt 

Section 003 (10 - 10:50 am): Esther Birch

Section 004 (11 - 11:50 am): Esther Birch

Section 005 (12 - 12:50 pm): Melinda Yager

Section 006 (1:10 - 2 pm): Melinda Yager

Section 007 (2:10 - 3 pm): Jeremiah Pharr

Section 011 (2:10 - 3 pm) in WILSON 1-119: DJ Moritz 

Section 008 (3:10 - 4 pm): Jeremiah Pharr

Section 012 (3:10 - 4 pm) in WILSON 1-119: McBeth Ahortor 
...
email: dennismoritz@montana.edu
...
* [STAT 216 calendar](calendars/F26-Stat216_Calendar.pdf)
...
If you prefer to complete activities on a pdf copy using a stylus-enabled device, please speak to your instructor, and he or she will provide you with a PDF copy of the coursepack.  
...
* Per the [STAT 216 calendar](calendars/S26-Stat216_Calendar.pdf), the course will be broken down into modules and units.
* To begin each module, students will 
  + **read** assigned sections of the online textbook on that topic's content.
  + **watch** assigned videos on Canvas and complete video notes (either those located in the Stat 216 coursepack or by taking your own notes on the assigned videos) **(video note completion is checked in class)**
...
grades$category <- fct_relevel(grades$category, "Preparation", "Engagement", "Assignments", "Module Labs", "Midterm exams (2)", "Final exam")
...
* You may take notes on your own or use the guided video notes (found in the coursepack).  Video notes will be checked off at the start of class the first day of the new module. 
    + A 25% *per class day* late penalty will apply for turning in video notes after the first day of a module.
...
Group midterm exams will be **Friday, September 25th and Wednesday, October 28th (during normal class time)**. 
...
Individual midterm exams will be **Monday, September 28th and Friday, October 30th (during normal class time)**. 
...
Group final exam will be **Wednesday, December 9th and Friday, December 11th (during normal class time)**. 
...
Individual common hour final exam will be **set by the registrars office the first month of Fall semester.  This will likely be Thursday, December 17th from 6 - 7:50 pm.**.
...
* You will be allowed to create two pages of note sheets for the exam.  You will also be provided a one page formula sheet during the exam.
...
* **Assignments**: 
    - You may edit an assignment in Gradescope as many times as you like up until the due date using the Resubmit button to re-open an assessment.
...
* **Preparation/Video Notes**: 
    - Video notes are due the first day of each new module. You may turn in the video notes later in a module with a 25% per class late penalty (meaning turning in video notes the second day of a module is worth up to 75%, turning in video notes the third day of a module is worth up to 50%, etc.)
    - Video notes may not be turned in for credit after a module has been completed.
...
**<mark style="background-color: lightblue"> In STAT 216, assignments and exit tickets that include the same wording as another student, regardless of whether that student was cited in your sources, will be considered plagiarism and will be treated as such.</mark> Students involved in plagiarism on assignments and exit tickets (all parties involved) will receive a zero grade on that assignment/exit ticket. The second offense will result in a zero on that assignment/exit ticket, and the incident will be reported to the Dean of Students. Academic misconduct on an exam will result in a zero on that exam and will be reported to the Dean of Students, without exception.**
